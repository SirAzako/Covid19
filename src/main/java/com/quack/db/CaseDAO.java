...
public class CaseDAO {
    ...
    /**
     * <p>
     *     A method that returns the case we wanna find by afm.
     * </p>
     * @param afmInput the afm of the case we search
     * @return it returns the case object.
     * */
    public Case getPersonByAfm(final String afmInput)
        ...
        try {
            ...
            String querry = "SELECT * "
                            ...
                            + "WHERE AFM = ?;";
            PreparedStatement stmt = con.prepareStatement(querry);
            stmt.setString(1, afmInput);
            ResultSet rs = stmt.executeQuery();

            if (rs.next()) {
                krousma = new Case(rs.getInt("ContactsNumber"),
                        rs.getString("Diagnosis"),
                        rs.getString("Death"),
                        rs.getString("Recovery"),
                        rs.getInt("AFM"),
